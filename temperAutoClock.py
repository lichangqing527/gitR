...
headers = {'Host': 'xsgzgl.zxhnzq.com', 'Connection': 'keep-alive',
           ...
           'content-type': 'application/json', 'env': 'production', 'positionID': '4955747', 'terminal': 'miniprogram',
...
data = {"usercode": "20191799", "xq": "20211", "typeid": 5, "remark": "体温打卡", "biztime": biztime, "lat": 28.68202,
...
data_len = len(data)
headers = {'Host': 'xsgzgl.zxhnzq.com', 'Connection': 'keep-alive', 'Authorization': Authorization,
           'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36 MicroMessenger/7.0.9.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat',
...
headers = {'Host': 'xsgzgl.zxhnzq.com', 'Connection': 'keep-alive', 'Authorization': Authorization, 'charset': 'utf-8',
           'positionid': str(positionID),
           'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36 MicroMessenger/7.0.9.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat',
           'content-type': 'application/json', 'terminal': 'miniprogram', 'Accept-Encoding': 'gzip,compress,br,deflate',
           'env': 'production', 'version': '2.0.44',
